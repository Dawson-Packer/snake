...
// Compilation command: g++ src/main.cpp src/Window.cpp src/App.cpp src/Game.cpp -IC:\mingw64\include -I..\include -LC:\mingw64\lib -lmingw32 -lSDL2main -lSDL2 -o snake.exe
